            ...
            ?>
              ...
              <ul class="list-group list-group-flush">
                <form action="product.php" method="GET">
                  ...
                  <br><br>
                  <img src="hey.png" alt="" height="100px" style="padding:5px;">
                  <img src="hey2.png" alt="" height="100px" >
                  <!-- <p style="font-family: Arial, Helvetica, sans-serif;padding: 5px;
  color: blue;">Free Delivery&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  Pay On Delivery</p> -->
                  <!-- <p style="color:blue;">Payment Mode : Cash On Delivery</p>
