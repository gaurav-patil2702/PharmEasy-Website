  ...
  <div class="container-fluid ">
    ...
    <div class="row" id="cards">
        ...
        <div class="card " style="background-color: rgb(93, 179, 207) ;height: 70%; ">
          <div class="card-body">
            ...
            <a href="search.php?cat=self-care">
              <img src="Self_care.jpg" style=" height:190px ;width:160px">
            </a>
            <br><br><br>
        ...
        <div class="card " style="background-color: rgb(81, 211, 216);height: 70%; ">
          <div class="card-body">
            ...
            <a href="search.php?cat=machine">
              <img src="images/machine.jpg" style="width:130px ; height: 190px;"><br>
            </a>
            <br> <br>
      ...
      <div class="col-sm-3" id="cards">
        <div class="card " style="background-color: AntiqueWhite; height: 70%;">
          <div class="card-body">
            <h5 style="font-weight:bold; color: rgb(104, 97, 97);">Near Stores</h5>
            </strong>
            ...
            <br> <br><br>
            <a href="https://www.justdial.com/Aurangabad-Maharashtra/Chemists/nct-10096237" target="_blank"> <button class="rounded-2" style="background-color: #00b9e1;
