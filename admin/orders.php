    ...
    <main class="d-flex justify-content-center text-center">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <form class="d-flex justify-content-center" method="GET" action="orders.php">
                ...
                <table class="table table-striped table-bordered text-center w-auto">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td><?php echo $i ?></td>
                                <td><?php echo isset($data[$i]['order_id']) ? $data[$i]['order_id'] : ''; ?></td>
                                <td><?php echo isset($data[$i]['user_id']) ? $data[$i]['user_id'] : ''; ?></td>
                                <td><?php echo isset($data[$i]['item_id']) ? $data[$i]['item_id'] : ''; ?></td>
                                <td><?php echo isset($data[$i]['order_quantity']) ? $data[$i]['order_quantity'] : ''; ?></td>
                                <td><?php echo isset($data[$i]['order_date']) ? $data[$i]['order_date'] : ''; ?></td>
                                <td>
                                    <?php
                                    if (isset($data[$i]['order_status'])) {
                                ...
                                <?php if (isset($data[$i]['order_status']) && $data[$i]['order_status'] == 1) { ?>
                                    <td>
            ...
            ?>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <form action="admin.php" method="POST" class="text-start">
