...
<body>
    ...
    <div class="container-fluid">
        ...
        ?>
            ...
            <form action="final.php?order=done" method="post">
            <div style="margin-left: 350px; padding-right: 100px;">
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                <!-- <a href="final.php?order=done" name="send_email" class="btn btn-outline-success btn-lg"> &nbsp;Proceed to Buy &nbsp;</a> -->
                <input type="hidden" name="send_email" value="1">
                <button type="submit" class="btn btn-outline-success btn-lg">Proceed to Buy</button>
            </form>
        ...
        ?>
            ...
            <p style="text-align: center; font-family: 'Fredoka One', cursive;">Please add at least 1 product to Buy</p>
